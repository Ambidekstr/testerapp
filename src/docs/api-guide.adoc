...
Now as you registrate a user you can login with an appropriate email and password.  
...
include::{snippets}/find-user-by-email/path-parameters.adoc[]
...
Another feature is uploading of pictures. You can upload a picture (max size 500KB) with a form. You can find this form by `GET` request on  
